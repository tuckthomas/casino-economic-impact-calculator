window.initSubstitutionCharts = function ()
{
    ...
    if (ctxBefore)
    {
        ...
        if (ctxBefore.chartInstance) ctxBefore.chartInstance.destroy();

        const chartB = new Chart(ctxBefore.getContext('2d'), {
            type: 'doughnut',
            data: {
        ...
        ctxBefore.chartInstance = chartB;
    }
    ...
    if (ctxAfter)
    {
        if (ctxAfter.chartInstance) ctxAfter.chartInstance.destroy();

        const chartA = new Chart(ctxAfter.getContext('2d'), {
            type: 'doughnut',
            data: {
                labels: labels,
                datasets: [{
