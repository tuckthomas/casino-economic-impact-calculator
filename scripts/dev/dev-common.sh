...
readonly PORT="5000"
readonly PROJECT_PATH="SaveNEIN.Server/SaveNEIN.Server.csproj"
readonly SERVER_WORKDIR="${REPO_ROOT}/SaveNEIN.Server"
readonly SERVER_BINARY="${REPO_ROOT}/SaveNEIN.Server/bin/Debug/net10.0/SaveNEIN.Server"
