    ...
    public string Render(CasinoImpactReportModel model, ReportPresentationOptions options)
    {
        ...
        if (model.Fiscal is not null)
        {
            ...
            [
                ...
                ("Other gaming-revenue charges", Money(model.Fiscal.OtherGamingRevenueCharges)),
                ("Municipal other-gaming share", Money(model.Fiscal.MunicipalOtherGamingRevenueShare)),
                ("County other-gaming share", Money(model.Fiscal.CountyOtherGamingRevenueShare)),
                ("Regional other-gaming share", Money(model.Fiscal.RegionalOtherGamingRevenueShare)),
                ("State other-gaming share", Money(model.Fiscal.StateOtherGamingRevenueShare)),
