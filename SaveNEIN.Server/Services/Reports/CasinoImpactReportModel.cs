        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var fiscal = await db.ModelRunFiscalImpacts.AsNoTracking()
            ...
            .Select(item => new ReportFiscal(
                ...
                item.OtherGamingRevenueCharges,
                item.MunicipalOtherGamingRevenueShare,
                item.CountyOtherGamingRevenueShare,
                item.RegionalOtherGamingRevenueShare,
                item.StateOtherGamingRevenueShare,
