    ...
    public class ReportController : ControllerBase
    {
        ...
        public async Task<IActionResult> GenerateReport([FromBody] ReportRequest request)
        {
            ...
            try
            {
                ...
                {
                    Path.Combine(_env.ContentRootPath, "..", "SaveNEIN.Client", "wwwroot", "assets", "SaveNEIN_Dark_Mode.png"),
                    Path.Combine(_env.ContentRootPath, "wwwroot", "assets", "SaveNEIN_Dark_Mode.png"),
                    Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "assets", "SaveNEIN_Dark_Mode.png")
                };
                ...
                void AddFooter(PageDescriptor page, byte[]? logo)
                {
                    page.Footer()
                        .Row(row => {
                            ...
                            {
                                 row.RelativeItem().AlignLeft().Text("SaveNEIN.com").FontSize(10).FontColor(Colors.Grey.Medium);
                            }
                ...
                var document = Document.Create(container =>
                {
                    ...
                    container.Page(page =>
                    {
                        ...
                        page.Content().Column(col =>
                        {
                            ...
                            col.Item().AlignCenter().Text("Northeast Indiana Casino Proposal").FontSize(18).SemiBold().FontColor(Colors.Grey.Darken1);
                            ...
                            col.Item().PaddingTop(4, Unit.Centimetre).AlignCenter().Column(c => 
                            {
                                 ...
                                 c.Item().Text("Prepared by: SaveNEIN Analytics").FontSize(14).Bold();
                            });
                ...
                return File(stream, "application/pdf", $"SaveNEIN_Report_{DateTime.Now:yyyyMMdd}.pdf");
            }
            catch (Exception ex)
            {
