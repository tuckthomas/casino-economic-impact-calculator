...
> - **SUCCESS:** Three finalized, source-extracted public benchmark cases are now persisted without accepting observed values from the request body. Fort Wayne run `18ce6a6d-4d7a-4649-8a1d-a33d6702bed2` produces $194.94 million resident/total GGR versus CBRE's $216.7 million local-gravity component (-10.04%) and $282.3 million total including traffic (-30.95%). DeKalb run `389e7aee-dc48-417c-89a2-1afebe733c28` produces $195.35 million versus Spectrum's $204.3 million adjusted receipts (-4.38%). Steuben run `0c7fd198-d4be-4e4c-9611-7ef248777bd5` produces $193.64 million versus Steinberg's $194.5 million resident base (-0.44%) and $203.1 million stabilized 2030 total including tourism (-4.66%). All three use exact Valhalla routes and a common disclosed pre-calibration surface (`beta=1.5`, outside option `1e-8`, proposed structural scale `4.0`); those values were not fitted separately to each target.
> - **WARNING:** Benchmark differences are explainable but not yet production-accepted. The stored runs currently add no site-addressable tourism or traffic amount, Steuben uses current-vintage demand without the planned 2030 population projection, and Spectrum had confidential operator rated-play data unavailable to this project. State-level proposed resident GGR is generated dynamically: Fort Wayne is IN $155.00M / MI $6.62M / OH $33.32M; DeKalb is IN $133.64M / MI $27.75M / OH $33.97M; Steuben is IN $105.76M / MI $52.30M / OH $35.58M. Incumbent deltas also identify a competitive-universe gap: the current snapshot contains Michigan Four Winds properties but omits Four Winds South Bend, so CBRE's published -$11.6M South Bend impact cannot yet be compared directly. Production calibration, incumbent holdouts, projection, and that tribal-facility coverage remain open.
...
- [x] Test an Allen/Fort Wayne-area development program. *(Run `18ce6a6d-4d7a-4649-8a1d-a33d6702bed2` is registered against CBRE's source-extracted local-gravity component; production calibration remains open.)*
- [x] Test an I-69/DeKalb/Spectrum-like proxy. *(Run `389e7aee-dc48-417c-89a2-1afebe733c28` uses the disclosed I-69/SR 8 analyst proxy, not parcel precision.)*
- [x] Test a Steuben scenario. *(Run `0c7fd198-d4be-4e4c-9611-7ef248777bd5` uses the disclosed I-69/US 20 analyst proxy, not parcel precision.)*
